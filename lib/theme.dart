...
TextStyle titleJobTextStyle = GoogleFonts.poppins(
...
TextStyle availableTextStyle = GoogleFonts.poppins(
...
TextStyle subRequirementsTextStyle = GoogleFonts.poppins(
    color: Color(0xff272C2F), fontSize: 14, fontWeight: FontWeight.w300);

TextStyle messageButton = GoogleFonts.poppins(
